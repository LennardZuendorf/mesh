...
the substring fallback. It is deliberately looser than :class:`~brain.schemas.note.Note`:
the corpus includes coexisting non-brain (foreign) Markdown files, so ``id`` /
