...
the substring fallback. It is deliberately looser than :class:`~mesh.schemas.note.Note`:
the corpus includes coexisting non-mesh (foreign) Markdown files, so ``id`` /
